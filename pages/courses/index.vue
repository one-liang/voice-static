<template>
  <div class="flex">
    <section
      class="fixed z-10 w-full lg:px-6 lg:static lg:py-12 lg:w-1/4 bg-teal"
    >
      <SearchInput
        :classifier-open.sync="classifierOpen"
        placeholder-name="找課程"
    ...
    >
      <div class="flex items-center mb-4 space-x-3 divide-x divide-gray-600">
        <h1 class="text-2xl font-bold lg:text-4xl text-teal">
          聽課程
        </h1>
        <NuxtLink
...
export default {
  ...
  head () {
    return {
      titleTemplate: '聽課程 - 鏡好聽 Mirror Voice',
      meta: [
        {
          hid: 'og:title',
          name: 'og:title',
          content: '聽課程 - 鏡好聽 Mirror Voice'
        },
        {
          hid: 'og:url',
          name: 'og:url',
