          ...
          >
            <div class="flex items-center mb-2">
              <NuxtLink
                ...
                class="inline-block px-2 mr-2 text-sm tracking-wide text-white lg:text-lg bg-blue-light"
              >
                有聲書
              </NuxtLink>
              <template v-for="(category, index) in 5">
                <NuxtLink
                  v-if="index === 0"
                  ...
                  class="text-sm lg:text-lg text-blue-light"
                >
                  有聲書分類
                </NuxtLink>
              </template>
