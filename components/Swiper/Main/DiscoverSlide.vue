        ...
        <div class="info">
          ...
          >
            <div class="flex items-center mb-2">
              <span
                class="inline-block px-2 mr-2 text-sm tracking-wide text-white lg:text-lg bg-secondary"
              >發現</span>
              <span class="text-sm lg:text-lg text-secondary">
                發現分類
              </span>
            </div>
            <NuxtLink
            ...
            <div class="mb-2 truncate lg:mb-4">
              <span class="text-sm text-secondary lg:text-base symbol">發現作者</span>
            </div>
            <div class="text-gray-500 truncate divide-x divide-gray-500">
              <span
                v-for="tag in 5"
                :key="`discover_tag_${tag}`"
                class="tag"
              >標籤名稱</span>
            </div>
            <footer
...
.tag {
  @apply pr-2 text-sm text-gray-500;
