          ...
          >
            <div class="flex items-center mb-2">
              <NuxtLink
                ...
                class="inline-block px-2 mr-2 text-sm tracking-wide text-white lg:text-lg bg-teal"
              >
                課程
              </NuxtLink>
              <template v-for="(category, index) in 3">
                <NuxtLink
                  v-if="index === 0"
                  ...
                  class="text-sm lg:text-lg text-teal"
                >
                  課程分類
                </NuxtLink>
              </template>
            ...
            <div class="truncate">
              ...
              >主持人</span>
              <template v-for="coursePresenter in 1">
                <NuxtLink
                  :key="`coursePresenter_${coursePresenter}`"
                  :to="{
                    name: 'voices-course-presenter-id',
                    params: { id: coursePresenter },
                  }"
